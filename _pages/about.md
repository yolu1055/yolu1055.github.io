...
<ul style="font-size:18px">
  <li style="margin-bottom: 0px"> Deep Generative Models</li>
  <li style="margin-bottom: 0px"> Structured Prediction</li>
  <li style="margin-bottom: 0px"> Motion Forecasting and Planning</li>
</ul>
...
<ul style="font-size:18px">
  <li style="margin-bottom: 0px"> [2025.01] XXXXX</li>
  <li style="margin-bottom: 0px"> [2025.02] AAAAAA</li>
</ul> -->
